package com.example.root.Upload_User_Detail;
...
public class Upload_Detail extends AppCompatActivity implements AdapterView.OnItemSelectedListener {
    ...
    private void UploadingDataToParse(){
        final ProgressDialog progressDialog = new ProgressDialog(Upload_Detail.this,R.style.AppTheme_Dark_Dialog);
    ...
    private void notification() {
        ...
        alert.setPositiveButton("Continue", new DialogInterface.OnClickListener() {
            public void onClick(DialogInterface dialog, int whichButton) {
                Intent i = new Intent(Upload_Detail.this, Select_Donor_Or_Receptor_3.class);
                startActivity(i);
                finish();
            }
        });
